...
router.post('/', async (req, res) => {
  try {
    ...
    const { name, web, address, city, state, products, dealerName, role, mail, phone, GST, pincode } = req.body;
    const dealer = new Dealer({ name, web, address, city, state, products, dealerName, role, mail, phone, GST, pincode });
