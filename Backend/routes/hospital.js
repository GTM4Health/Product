...
router.post('/', async (req, res) => {
  try {
    ...
    const { name, details, city, state, infraSer, docName, docSpez, mail, phone, speciality, lastConnected, pincode, address, category, addedBy, addedOnTime, beds, certification } = req.body;
    const hospital = new Hospital({ name, details, city, state, infraSer, docName, docSpez, mail, phone, speciality, lastConnected, pincode, address, category, addedBy,addedOnTime, beds, certification });
