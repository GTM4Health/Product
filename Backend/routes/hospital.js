...
router.post('/', async (req, res) => {
  try {
    ...
    const { name, details, city, state, infraSer, docName, docSpez, mail, phone, speciality, lastConnected, pincode, address, category, addedBy, addedOnTime, beds, certification, web } = req.body;
    const hospital = new Hospital({ name, details, city, state, infraSer, docName, docSpez, mail, phone, speciality, lastConnected, pincode, address, category, addedBy,addedOnTime, beds, certification, web });
