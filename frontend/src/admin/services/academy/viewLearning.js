...
const ViewLearningModules = () => {
    ...
    const fetchModules = async () => {
      try {
        const response = await axios.get(
          `${process.env.REACT_APP_BASE_URL}/api/learning/pdfs?page=${currentPage}&limit=${pageSize}`
        );
  ...
  const handleDownload = async (fileName) => {
    try {
      const response = await axios.get(`${process.env.REACT_APP_BASE_URL}/api/learning/download/${fileName}`, {
        responseType: 'blob',
      });
  ...
  const handleEditDetails = async () => {
    try {
      const response = await axios.put(
        `${process.env.REACT_APP_BASE_URL}/api/learning/edit/${editFileName}`,
        ...
        <div className="edit-form">
          ...
          <form onSubmit={handleEditDetails}>
            <div className="form-group">
              <label htmlFor="newFileName">New Module Name</label>
              <input
                type="text"
                id="newFileName"
                value={newFileName}
...
export default ViewLearningModules;
